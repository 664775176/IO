            ...
            if (num > 0) { // 判断是否存在可用的通道
                ...
                while (iterator.hasNext()) {
                    ...
                    if (key.isAcceptable()) {
                        ...
                        System.out.println(Thread.currentThread().getId()+"处理请求："+ socketChannel.getRemoteAddress());
                        ...
                        System.out.println(Thread.currentThread().getId()+"服务器端接收到的数据："+ new String(baos.toByteArray()));
                        ...
                        writeChannel.close();
                        System.out.println(Thread.currentThread().getId()+"服务器端发送的数据："+ message);
                    }
                }
            }
        }
